  ...
  return (
    <form action={formAction} className="space-y-4">
      ...
      <div>
        ...
        <div className="relative">
          <Lock className="pointer-events-none absolute z-10 left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-neutral-400" />
          <PasswordInput id="password" name="password" required placeholder="••••••••" className="pl-9" />
        </div>
      </div>
      {accountInactive && (
